...
export default class Slider extends Component {
  ...
  render() {
    ...
    return (
        <section  className="hero-header hero-default default_overlay bg_img parallax-window page-header" data-src={Img} data-section-type="canvas_default_particles" style={{backgoundImage: `url(${Img})`}}>
